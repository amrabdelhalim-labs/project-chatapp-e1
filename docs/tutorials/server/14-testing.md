...
├── image.test.js            ← 38 اختبار — دورة حياة صورة الملف الشخصي (HTTP)
...
|-------|-------|-------|-----------|--------|
| **شامل** | comprehensive | 84 | كل شيء معاً | ⚡ سريع |
| **مستودعات** | repositories | 44 | CRUD فقط | ⚡ سريع |
| **تكامل** | integration | 46 | + تخزين + ملفات | 🕐 متوسط |
| **E2E** | api | 69 | HTTP حقيقي | 🕐 متوسط |
| **صور** | image | 38 | رفع/استبدال/حذف صورة الملف الشخصي | 🕐 متوسط |
| **تخزين** | storage | 54 | نهج + خدمة التخزين | ⚡ سريع (بدون شبكة) |
